...
libraryDependencies ++= Seq(
    ...
    "org.apache.spark" % "spark-core_2.10" % "1.2.0-cdh5.3.0" % "provided" excludeAll(excludeJBossNetty, excludeMortbayJetty, excludeAsm, excludeCommonsLogging, excludeOldAsm, excludeServletApi),
